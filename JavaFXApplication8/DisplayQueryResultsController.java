...
public class DisplayQueryResultsController {
   ...
   @FXML
   void RangedSearchButtonPressed(ActionEvent event){
   ...
   void NameSearchButtonPressed(ActionEvent event){
       ...
       String searchString = ORDER_SEARCH_BY + " where customers.lastname = '" + name + "'";
       queryTextArea.setText(searchString);
   }
   
   @FXML
   void PhoneSearchButtonPressed(ActionEvent event){
       String phone = PhoneFilter.getText();
       String searchString = ORDER_SEARCH_BY + " where customers.phonenumber = '" + phone + "'";
       queryTextArea.setText(searchString);
   }
   
   @FXML
   void SimpleSearchButtonPressed(ActionEvent event){
